...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item"><a class="nav-link text-light" href="../visitorModule/deconnection.php"><i class="fas fa-sign-out-alt mr-3"></i>Se deconnecter</a></li>
                </ul>
            </div>
        </div>
    </nav>
    <main class="page faq-page bg-dark">
        ...
        echo ('<div>');
        ?>
        <input type="button" name="newInsurance" value="Nouvelle assurance" onclick="newInsurance()">
        <input type="button" name="newManager" value="Nouveau compte manager" onclick="newManager()">
        <input type="button" name="mail" value="Messagerie" onclick="mail()">
        <div id="btns"></div>
        <div id="actualForm" class='text-light'></div>
        <div id="error" class="text-light faq-item"></div>
        <script>
            //ajouter le nouveau manager
            function newManager() {
                document.getElementById('btns').innerHTML = "";
                document.getElementById('actualForm').innerHTML = "";
                ...
                xhttp.send("newManager=ok");
            }
            //envoyer les données du nouveau manager
            function sendNewManager() {
                if (document.getElementById('fname').value != "" && document.getElementById('name').value != "" && document.getElementById('insurance').value != "") {
                    xhttp = new XMLHttpRequest();
                    xhttp.onreadystatechange = function() {
                        if (this.readyState == 4 && this.status == 200) {
                            document.getElementById("btns").innerHTML = this.responseText;
                    ...
                    xhttp.open("POST", "admin.php", true);
                    xhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                    xhttp.send("sendNewManager=ok&fname=" + document.getElementById('fname').value + "&name=" + document.getElementById('name').value + "&insurance=" + document.getElementById('insurance').value);
                } else {
            ...
            function newInsurance() {
                ...
                xhttp.open("POST", "admin.php", true);
                xhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                xhttp.send("newInsurance=ok");
            }
            //envoyer les données de la nouvelle assurance
            function sendNewInsurance() {
                document.getElementById("error").innerHTML = "";
                if (document.getElementById('name').value != "" && document.getElementById('adress').value != "" && document.getElementById('city').value != "" && document.getElementById('postalCode').value != "" && document.getElementById('country').value != "" && document.getElementById('phoneNumber').value != "" && document.getElementById('countryCode').value != "" && document.getElementById('insurerCode').value != "") {
                    document.getElementById('actualForm').innerHTML = "";
                    xhttp = new XMLHttpRequest();
                    xhttp.onreadystatechange = function() {
                        if (this.readyState == 4 && this.status == 200) {
                    ...
                    xhttp.open("POST", "admin.php", true);
                    xhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                    xhttp.send("sendNewInsurance=ok&name=" + document.getElementById('name').value + "&adress=" + document.getElementById('adress').value + "&city=" + document.getElementById('city').value + "&postalCode=" + document.getElementById('postalCode').value + "&country=" + document.getElementById('country').value + "&phoneNumber=" + document.getElementById('phoneNumber').value + "&countryCode=" + document.getElementById('countryCode').value + "&insurerCode=" + document.getElementById('insurerCode').value);
                } else {
                    document.getElementById("error").innerHTML = "<div class='faq-item'><h4 class='text-bold text-light'>Erreur, au moins un des champs est vide. </h4></div>";
                }

            }
            //faire apparaitre les bouttons des mails
            function mail() {
                document.getElementById("error").innerHTML = "";
                document.getElementById('btns').innerHTML = "";
                xhttp = new XMLHttpRequest();
                ...
                xhttp.open("POST", "mailAdmin.php", true);
                xhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                xhttp.send("mail=ok");
            }
            ...
            function readMail() {
                ...
                xhttp.onreadystatechange = function() {
                    if (this.readyState == 4 && this.status == 200) {
                        document.getElementById("actualForm").innerHTML = this.responseText;
                    }
                }
                xhttp.open("POST", "mailAdmin.php", true);
                xhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
            ...
            function readMessage(id) {
                for (let i = 0; i < document.getElementById('actualForm').children.length; i++) {
                    document.getElementById('actualForm').children[i].children[2].style.display = "none";
                }
            ...
            function sendMessage() {
                ...
                if (document.getElementById("mailContent").value != "" && document.getElementById("mailObject").value != "" && document.getElementById("receiver").value != "") {
                    ...
                    document.getElementById("error").innerHTML = "<div class='faq-item'><h4 class='text-bold text-light'>Erreur, veuillez choisir un destinataire.</h4></div>";
                } else {
                    document.getElementById("error").innerHTML = "<div class='faq-item'><h4 class='text-bold text-light'>Erreur, au moins un des champs est vide.</h4></div>";
                }
            }
